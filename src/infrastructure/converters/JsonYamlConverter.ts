...
export class JsonYamlBaseConverter implements TranslationConverter {
    ...
    parse(content: string): POFile {
        ...
        return {
            charset: 'utf-8',
            header: {
                content: `${this.displayName} converted to PO`,
                metadata,
            },
            entries,
            obsolete: [],
    ...
    private extractEntries(data: Record<string, any>): POEntry[] {
    ...
    private buildObject(entries: POEntry[]): Record<string, any> {
