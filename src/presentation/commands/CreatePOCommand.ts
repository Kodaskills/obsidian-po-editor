...
export class CreatePOCommand {
  ...
  private async mergePotTemplate(poFile: POFile, potFile: FileRef): Promise<POFile> {
    ...
    const potResult = await parsePOUseCase.execute({
      content: potContent,
