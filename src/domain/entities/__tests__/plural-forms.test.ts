...
import { getPluralFormSpec, pluralFormsHeader, parseNplurals, getPluralFormLabels } from '../PluralForms';
...
const getPluralFormSpecCases = [
    ...
    { name: 'Russian', input: 'ru', expectedPlural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', expectedNplurals: 3 },
    { name: 'Arabic', input: 'ar', expectedPlural: '(n==0 ? 0 : n==1 ? 1 : n==2 ? 2 : n%100>=3 && n%100<=10 ? 3 : n%100>=11 && n%100<=99 ? 4 : 5)', expectedNplurals: 6 },
    { name: 'Slovenian', input: 'sl', expectedPlural: '(n%100==1 ? 0 : n%100==2 ? 1 : n%100==3 || n%100==4 ? 2 : 3)', expectedNplurals: 4 },
    { name: 'Polish', input: 'pl', expectedPlural: '(n==1 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', expectedNplurals: 3 },
    ...
    { name: 'Portuguese (underscore)', input: 'pt_br', expectedPlural: '(n > 1)', expectedNplurals: 2 },
    { name: 'Unknown language falls back to English', input: 'xyz', expectedPlural: '(n != 1)', expectedNplurals: 2 },
];

const pluralFormsHeaderCases = [
    { name: 'English plural forms', input: { nplurals: 2, plural: '(n != 1)' }, expected: 'nplurals=2; plural=(n != 1);' },
    { name: 'French plural forms', input: { nplurals: 2, plural: '(n > 1)' }, expected: 'nplurals=2; plural=(n > 1);' },
    { name: 'Japanese singular', input: { nplurals: 1, plural: '0' }, expected: 'nplurals=1; plural=0;' },
    { name: 'Russian plural', input: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)' }, expected: 'nplurals=3; plural=(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2);' },
];

const parseNpluralsCases = [
    { name: 'standard 2', input: 'nplurals=2; plural=(n != 1);', expected: 2 },
    { name: 'standard 3', input: 'nplurals=3; plural=(n==1 ? 0 : n>=2 && n<=4 ? 1 : 2);', expected: 3 },
