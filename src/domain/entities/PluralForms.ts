...
export const PLURAL_FORMS: Record<string, PluralFormSpec> = {
    ...
    // 2 forms — Romanian
    ro: { nplurals: 3, plural: '(n == 1 ? 0 : (n == 0 || (n % 100 > 0 && n % 100 < 20)) ? 1 : 2)', examples: 'Romanian' },
    // 3 forms — Slavic
    ru: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', examples: 'Russian' },
    uk: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', examples: 'Ukrainian' },
    be: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', examples: 'Belarusian' },
    sr: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', examples: 'Serbian' },
    hr: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', examples: 'Croatian' },
    bs: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', examples: 'Bosnian' },
    pl: { nplurals: 3, plural: '(n==1 ? 0 : n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2)', examples: 'Polish' },
    cs: { nplurals: 3, plural: '(n==1) ? 0 : (n>=2 && n<=4) ? 1 : 2', examples: 'Czech' },
    sk: { nplurals: 3, plural: '(n==1) ? 0 : (n>=2 && n<=4) ? 1 : 2', examples: 'Slovak' },
    lt: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n%10>=2 && (n%100<10 || n%100>=20) ? 1 : 2)', examples: 'Lithuanian' },
    lv: { nplurals: 3, plural: '(n%10==1 && n%100!=11 ? 0 : n != 0 ? 1 : 2)', examples: 'Latvian' },
    // 4 forms
    sl: { nplurals: 4, plural: '(n%100==1 ? 0 : n%100==2 ? 1 : n%100==3 || n%100==4 ? 2 : 3)', examples: 'Slovenian' },
    // 6 forms
    ar: { nplurals: 6, plural: '(n==0 ? 0 : n==1 ? 1 : n==2 ? 2 : n%100>=3 && n%100<=10 ? 3 : n%100>=11 && n%100<=99 ? 4 : 5)', examples: 'Arabic' },
};
...
export function getPluralFormLabels(nplurals: number): string[] {
    switch (nplurals) {
        ...
        case 3: return ['One', 'Few', 'Other'];
        case 4: return ['One', 'Two', 'Few', 'Other'];
        case 6: return ['Zero', 'One', 'Two', 'Few', 'Many', 'Other'];
        default: return Array.from({ length: nplurals }, (_, i) => `Form ${i}`);
    }
}
